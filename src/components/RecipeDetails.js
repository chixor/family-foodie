        ...
        return (
            <article>
                <div className="recipedetail">
                    ...
                    {
                        !this.state.editing ?
                            <button onClick={() => this.toggleEdit()} className="btn btn-default"><span className="glyphicon glyphicon-pencil"></span> Edit</button>:
                            <div>
                                <button onClick={() => this.addIngredient()} className="btn btn-default"><span className="glyphicon glyphicon-plus"></span> Add Ingredient</button>
                                &nbsp;<button onClick={() => this.save()} className="btn btn-success"><span className="glyphicon glyphicon-ok"></span> Save</button>
                                &nbsp;<button onClick={() => this.delete()} className="btn btn-danger"><span className="glyphicon glyphicon-remove"></span> Delete</button>
                                &nbsp;<button onClick={() => this.toggleEdit()} className="btn btn-default"><span className="glyphicon glyphicon-remove"></span> Cancel</button>
                            </div>
                    }
                    </div>
                    </div>
