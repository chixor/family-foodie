...
export default {
    ...
    if (id) {
      return axios
        .put(`${BASEURL}/recipe/${id}`, {
          data: { details, ingredients, deleteIngredients },
        })
        .then((response) => {
  ...
  saveWeek(week) {
    ...
    return axios
      .put(`${BASEURL}/week/${week.year}/${week.week}/`, {
  ...
  addShoppingListItem(week, name) {
    return axios
      .post(`${BASEURL}/shopping/${week.year}/${week.week}/`, {
        data: { name },
      })
      .then((response) => {
  ...
  deleteShoppingListItem(week, id) {
    return axios
      .delete(`${BASEURL}/shopping/${week.year}/${week.week}/`, {
        data: { id },
      })
      .then((response) => {
